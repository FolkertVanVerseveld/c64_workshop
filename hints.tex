...
\problem Spreekt voor zich. Lees de laatste zin van de vraag nog een keer.

\problem \verb:POKE: is het tegenovergestelde van \verb:PEEK:.

\problem Voeg een \verb:PRINT: toe voor regel 10 en pas de tekst bij regel 20 aan.
