...
.var zp_fade_text = $3
.var zp_fade_idx = $4
.var zp_fade_row_idx = $5
.var zp_fade_row_top = $6 // word
.var zp_fade_row_bot = $8 // word
.var zp_fade_row_top_col = $a // word
.var zp_fade_row_bot_col = $c // word
.var zp_fade_mode = $e
.var zp_fade_row_step = $f
...
!l:
	dey
	sta (zp_fade_row_top_col), y
	sta (zp_fade_row_bot_col), y
	bne !l-
*/
